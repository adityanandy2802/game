...
while (True):
    ...
    # Quit
    if (k == ord("q")):
        cv2.rectangle(img, (350, 270), (200, 210), (255, 255, 255), thickness=-1)
        cv2.putText(img, "Quit? y/n", (200, 250), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 0, 255), thickness=2)
        cv2.imshow("img", img)
        m = cv2.waitKey(0)
        while (m != ord('y') and m != ord('n')):
            cv2.rectangle(img, (350, 270), (200, 210), (255, 255, 255), thickness=-1)
            cv2.putText(img, "Quit? y/n", (200, 250), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 0, 255), thickness=2)
            cv2.imshow("img", img)
            m = cv2.waitKey(0)
...
if (defeat == 1):
    ...
    k = cv2.waitKey(0)
#     cv2.rectangle(img,(350,270),(200,210),(255,255,255),thickness=-1)
#     cv2.putText(img,"Play? y/n",(200,250),cv2.FONT_HERSHEY_SIMPLEX,1.0,(0,0,255),thickness=2)
#     cv2.imshow("img",img)
#     k=cv2.waitKey(0)
